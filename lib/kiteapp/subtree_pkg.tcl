...
proc ::kiteapp::subtree::pkg {name module} {
...
codeblock ::kiteapp::subtree::Pkg_pkgIndex {name} {
...
codeblock ::kiteapp::subtree::Pkg_pkgModules {name module} {
    set project [project name]
    set version [project version]
    set description [project description]
} {
...
codeblock ::kiteapp::subtree::Pkg_module {name module} {
    set project     [project name]
    set description [project description]
} {
    #-----------------------------------------------------------------------
...
codeblock ::kiteapp::subtree::Pkg_all_tests {name} {
    set project     [project name]
    set description [project description]
} {
    # -*-Tcl-*-
...
codeblock ::kiteapp::subtree::Pkg_test {name module} {
    set project     [project name]
    set description [project description]
} {
    # -*-Tcl-*-
