...
#
# DESCRIPTION:
#   Kite: kutils(n) docs module; knows how to build documentation in 
#   the /docs directory. Used by buildtool and docstool.
#
#-----------------------------------------------------------------------

namespace eval ::kutils:: {
    namespace export docs
}

#-----------------------------------------------------------------------
# docs ensemble

snit::type ::kutils::docs {
    # Make it a singleton
    ...
    #            marsdoc(5) files.  
    #
    # Builds all marsdocs found in docs/ and its subdirectories, or
    # just in the given subdirectory.  NOTE: Any .ehtml file found
    # in docs or its subdirectories, other than the "man*" subdirectories,
    # is assumes to be a marsdoc(5) file.

    typemethod marsdocs {{dirname ""}} {
        # This is needed when bootstrapping Kite itself.
    ...
    # 
    # Formats all of the marsdoc(5) files in the directory.

    proc FormatMarsDocs {dir} {
        ...
        try {
            ...
            throw FATAL "Syntax error in marsdoc(5) file: $result"
        }
    }
    ...
    # GetManRoots dir
    #
    # dir   - A directory of marsdoc(5) files
    #
