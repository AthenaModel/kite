...
#
# DESCRIPTION:
#   Kite: app_kite(n), "proj" subtree writer: project files
#
#-----------------------------------------------------------------------
...
codeblock subtree::Proj_gitignore {} {
    # Kite Artifacts
    /.kite
    /includes
    /docs/man*/*.html
